...
options={}
options['input_pdb']='CaAspinput.pdb'
options['energy_function']='-empty'
options['constraint_file']='A011_Asp_highA.cst'
options['extra_res_fa']='CAL.params CO3.params'
options['jump']=4
options['Gaus_trans_mag']=float(0.15)
options['Gaus_rot_mag']=float(1.5)
options['Energy_cut']=-50
options['Resi_num']=5
options['Resi_name']='ASP'
options['hashtable_name']='CaCO3_hashtable'
options['target_phi_psi_list'] = [(-118.5, 118.3), (-77.6, 175.9), (-63.6, 148.9), (63.2, 17.1), (74.2, 9.9), (-105.6, 110.3), (-64.0, 132.3), (69.4, -2.7), (-90.3, 107.8), (-55.3, 120.8)]
options['orient_atoms'] = ['OD1','CG','OD2']
options['create_ray_atoms_num']=[1,2,2,4]
options['create_ray_atoms_name']=['Ca2p','C1','O1','O1']
