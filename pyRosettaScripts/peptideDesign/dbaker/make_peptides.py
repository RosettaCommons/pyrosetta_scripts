...
def generate_peptides(Nsamples,frange,dump_pdb):
  p=Pose()
  pdbs={}
  rosetta.core.pose.make_pose_from_sequence(p, "AAAAAAAAAAAAAAAAAA","fa_standard")
  torsions=[]
  helical_params=[]
  for i in range(Nsamples):
    phi1, psi1 =choose_torsions(frange,'THR')
    phi2, psi2 =choose_torsions(frange,'THR')
    torsions.append([phi1,psi1,phi2,psi2])
...
pept_gen = generate_peptides(npept,20.,0)  #Nstruct, angle variance, output_pdb
